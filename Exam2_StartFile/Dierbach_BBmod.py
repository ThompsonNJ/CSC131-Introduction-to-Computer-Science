...
#    - run the simulation for 5 sec
#    - create exactly 4 balls
#    - change balls to red squares when they hit the sides
#    - change balls to blue triangles when they hit top or bottom
